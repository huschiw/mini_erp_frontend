...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed lg:static inset-y-0 left-0 z-50 flex h-screen w-64 flex-col border-r border-zinc-200 bg-white text-zinc-900 dark:bg-zinc-950 dark:text-white dark:border-zinc-800 transition-transform duration-300 ease-in-out lg:translate-x-0",
      ...
      <div className="border-b border-zinc-200 dark:border-zinc-800 p-6 pt-12 lg:pt-6">
